...
import {ArrowLeftRight, Bell, Code, Coins, Download, Gift, LayoutDashboard, LifeBuoy, Loader2, Moon, PlusCircle, Receipt, Send, Settings, Sparkles, Sun, TrendingUp, Wallet} from "lucide-react";
